...
function createBlogCard(post) {
  ...
  card.innerHTML = `
        ...
        <div class="blog-content">
            ...
            <a href="#" class="read-more" onclick="openBlogModal(${post.id})">
...
function handleBlogForm(e) {
  ...
  const images = document.getElementById("blog-images").files
...
function initializeScrollAnimations() {
  ...
  document.querySelectorAll(".feature, .blog-card").forEach((el) => {
    el.style.opacity = "0"
